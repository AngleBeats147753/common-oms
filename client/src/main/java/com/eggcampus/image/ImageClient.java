...
public class ImageClient {
    ...
    public static final String USE_IMAGE_LIST_URL = "/image/useList";
    ...
    public void useImageList(List<String> imageList, boolean needCheck) {
        JSONObject body = new JSONObject();
        List<UsageQO> usageQoList = new ArrayList<>(imageList.size());
